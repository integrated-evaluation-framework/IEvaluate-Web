...
export const MOCK_APPS: EvaluatedApplication[] = [
  {
    ...
    permissions: {},
    tasks: ['MOCK_AI_EXTRACTION_1', 'MOCK_AI_EXTRACTION_3', 'MOCK_AI_INFERENCE_1', 'MOCK_AI_INFERENCE_2', 'MOCK_AI_INFERENCE_3'],
    settings: {
      abstraction: {
        minQuorumCount: 3,
        minQuorumProportion: 0.5,
        showAbstractorAssertionsBeforeQuorum: Math.random() > 0.5
      }
    }
  },
  {
  ...
  },
  {
    id: '3',
    name: 'Application 3',
    description: 'Mock Application 3',
    permissions: {},
    tasks: ['MOCK_AI_EXTRACTION_1', 'MOCK_AI_EXTRACTION_3', 'MOCK_AI_INFERENCE_1', 'MOCK_AI_INFERENCE_2', 'MOCK_AI_INFERENCE_3'],
    settings: {
      abstraction: {
  ...
  },
  {
    id: '4',
    name: 'Application 4',
    description: 'Mock Application 4',
    permissions: {},
    tasks: ['MOCK_AI_EXTRACTION_1', 'MOCK_AI_EXTRACTION_3', 'MOCK_AI_INFERENCE_1', 'MOCK_AI_INFERENCE_2', 'MOCK_AI_INFERENCE_3'],
    settings: {
      abstraction: {
  ...
  },
  {
    id: '5',
    name: 'Application 5',
    description: 'Mock Application 5',
    permissions: {},
    tasks: ['MOCK_AI_EXTRACTION_1', 'MOCK_AI_EXTRACTION_3', 'MOCK_AI_INFERENCE_1', 'MOCK_AI_INFERENCE_2', 'MOCK_AI_INFERENCE_3'],
    settings: {
      abstraction: {
